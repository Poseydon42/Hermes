...
namespace Hermes
{
	...
	struct Vector3
	{
		 ...
		 */
		constexpr Vector3 SafeNormalized(InternalType Epsilon = InternalType(FLT_EPSILON)) const;
	...
	template <typename InternalType>
	constexpr Vector3<InternalType> Vector3<InternalType>::Normalized() const
	{
		return *this / Length();
	}

	template <typename InternalType>
	constexpr Vector3<InternalType> Vector3<InternalType>::SafeNormalized(InternalType Epsilon) const
	{
