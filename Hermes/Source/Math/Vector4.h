...
namespace Hermes
{
	...
	struct Vector4
	{
		 ...
		 */
		constexpr Vector4 SafeNormalized(InternalType Epsilon = InternalType(FLT_EPSILON)) const;
	...
	template <typename InternalType>
	constexpr Vector4<InternalType> Vector4<InternalType>::Normalized() const
	{
		return *this / Length();
	}

	template <typename InternalType>
	constexpr Vector4<InternalType> Vector4<InternalType>::SafeNormalized(InternalType Epsilon) const
	{
