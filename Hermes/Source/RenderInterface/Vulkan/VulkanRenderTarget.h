...
namespace Hermes
{
	namespace Vulkan
	{
		...
		public:
			VulkanRenderTarget(std::shared_ptr<const VulkanDevice> InDevice, const std::shared_ptr<RenderInterface::RenderPass>& InRenderPass, std::vector<std::shared_ptr<RenderInterface::Image>> InAttachments, Vec2ui InSize);
