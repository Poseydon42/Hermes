...
function(add_test_executable test_name test_sources dependencies)
    ...
    target_compile_definitions(${test_name} PRIVATE HERMES_TEST_FILES_DIR="${CMAKE_CURRENT_SOURCE_DIR}/Files")
    target_link_libraries(${test_name} PRIVATE ${dependencies} GTest::gtest_main GTest::gmock_main)
